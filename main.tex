...
\begin{document}
	...
	\input{content/02_probleme/probleme}
	
	\chapter{Problemursachen}
	\input{content/03_ursachen/ursachen}
	
	\chapter{Konzept einer Softwarelösung}
	\input{content/04_konzept/konzept}
	
	\chapter{Entwurf der Softwarelösung}
	\input{content/05_entwurf/entwurf}
	
	\chapter{Implementierung der Softwarelösung}
	\input{content/06_implementierung/implementierung}
	
	\chapter{Einsatz der Softwarelösung}
	\input{content/07_einsatz/einsatz}
