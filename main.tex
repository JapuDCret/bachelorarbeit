...
\begin{document}
	...
	\newcommand*{\thedockind}{\textbf{Proposal} für die Bachelorarbeit}
	\newcommand*{\thetitle}{Bessere Nachvollziehbarkeit clientseitiger JavaScript-basierter\\Webapplikationen}
	\newcommand*{\thesubtitle}{Ein Ansatz zur Verbesserung der Nachvollziehbarkeit von Nutzerinteraktion und Anwendungsverhalten}
