...
\multicolumn{5}{|p{14.05cm}|}{Die erfassten Tracingdaten sind für die Nutzer des Systems einsehbar und können gefiltert werden. Die Filtierung erfolgt auf Basis von Eigenschaften der Tracingdaten (wie Name des meldenden Systems).} \\
\hline
\end{anf}
...
\multicolumn{5}{|p{14.05cm}|}{Es existiert ein \enquote{Session-Replay}-Partnersystem, zu dem die Daten zus Session-Replays gesendet werden und welches diese analysiert und speichert.} \\
\hline
\end{anf}
