...
\multicolumn{5}{|p{14.05cm}|}{Im Frontend sind beispielhaft Metriken zu erheben, wie z. B. die Zeit bis der Nutzer interagieren kann (Time to Interactive (TTI)) oder die Anzahl an Aufrufen je Schnittstelle} \\
\hline
\end{anf}
