...
\multicolumn{5}{|p{14.05cm}|}{Möglichkeit zum Export des fachlichen Modells der Webanwendung.} \\
\hline
\end{anf}

\begin{anf}{anf:2161}{2161}{Datadump-Import}{S}{f}{S}
\multicolumn{5}{|p{14.05cm}|}{Re-Import des fachlichen Modells der Webanwendung, um diesen Zustand auf anderen Systemen und für andere Systeme einsehbar zu machen.} \\
\hline
\end{anf}
