...
Entwickler und Betreiber von JavaScript-basierten Webapplikationen werden fast alltäglich mit Verständnisproblemen konfrontiert. Sie müssen beispielsweise zu Zwecken der Problembehebung oder Verbesserung nachvollziehen können, wie ein Nutzer die Applikation verwendet und wie sich die Applikation dabei verhält. Dies ist in der Umgebung von Browsern deutlich erschwert, als in anderen Projekten mit Nutzerinteraktion. Denn die notwendigen Informationen liegen beim Nutzer, für den Betreiber ist lediglich die Kommunikation zum Backend sichtbar.
...
Weiterhin gibt es die Herausforderung, dass das Verhalten einer Applikation nachvollziehbar gemacht wird. Dies ist abhängig von der Bewältigung des Hauptproblems, denn die Nachvollziehbarkeit soll aus Sicht der Stakeholder erreicht werden.
