...
\begin{enumerate}
	...
	\item Wie kann eine gute Nachvollziehbarkeit erreicht/verbessert werden?
	\begin{enumerate}
		\item Was benötigt man, um nachvollziehen zu können?
...
Durch das gewonnene Verständnis über die Ausgangssituation, sollen nun Methoden aufzeigt werden, wie man eine Nachvollziehbarkeit erreichen kann. Methoden wie Logging, Metriken, Tracing und ggf. andere sollen betrachtet werden.
