...
Eine der Webapplikation des Direktversicherers ermöglicht seinen Kunden (nachfolgend Nutzer genannt), dass sie selber ihre Daten eingeben können und darauf basierend Versicherungspreise erhalten, die auf der Situation der Nutzer basieren. Diese Webapplikation ist clientbasiert und jegliche Eingaben werden zunächst clientseitig zwischengespeichert. Nach Ausfüllung aller Eingaben, werden diese an einen Server übertragen, welcher daraufhin mit Preisen für einen Vertrag basierend auf den Eingaben antwortet.
...
Dabei ist zu beachten, dass das Projektumfeld sich im Web bewegt und Limitierungen von Browsern im Vergleich zu anderen Umgebungen existieren. Des Weiteren müssen gesetzliche Vorschriften sowie firmeninterne Vorgaben beachtet werden. Weiterhin ist für die Open Knowledge diese Hürde der Nachvollziehbarkeit kein Einzelfall, sondern stellt eine generelles Problem bei Webapplikationen dar.
