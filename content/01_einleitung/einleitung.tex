...
Die Open Knowledge GmbH betreut einen Kunden, welcher als Direktversicherer agiert. Direktversicherer bedeutet, dass die Vertreibung der Produkte nicht über Vermittler, sondern klassisch per Telefon oder Post bzw. heutzutage überwiegend im Netz stattfindet. Dementsprechend ist ein solider Internetauftritt für den Kunden wichtig und Open Knowledge unterstützt hierbei in der Beratung und der Weiterentwicklung.

Eine der Webapplikation des Direktversicherers ermöglicht seinen Kunden (nachfolgend Nutzer genannt), dass sie selber ihre Daten eingeben können und darauf basierend Versicherungspreise erhalten, die auf die Situation und Bedürfnisse der Nutzer abgestimmt ist. Diese Webapplikationen ist clientbasiert und beinhaltet viele Eingaben und darauf basierende Zustände. Diese Eingaben werden an einen Server übertragen, welcher daraufhin mit Preisen für Vertrag basierend auf den Eingaben antwortet.
