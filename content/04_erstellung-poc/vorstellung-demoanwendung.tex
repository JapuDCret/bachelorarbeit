...
Die einzelnen Dienste wurden mit Eclipse MicroProfile \cite{EclipseMicroprofile} umgesetzt. MicroProfile ist eine Kollektion von verschiedener Java EE Frameworks und Technologien zur Umsetzung von Microservices und zielt darauf ab diese weiterzuentwickeln und zu standardisieren. Speziell wurden die Dienste auf Basis von JAX-RS als REST-Services umgesetzt. 

Danach wurden die einzelnen Dienste in jeweils eigene Docker Images \cite{Docker} verpackt, um eine einheitliche Umgebung auch auf unterschiedlichen Rechnern zu gewährleisten. Diese Images wurden dann mit Kubernetes \cite{Kubernetes} aufgesetzt und miteinander verbunden.
