...
Um später mithilfe der Observability-Werkzeuge Probleme aufzudecken, besitzt die Demoanwendung einige simulierte problembehaftete Implementierungen. Diese Fehler wurden in Zusammenarbeit mit den Stakeholdern konzipiert. Bei der Konzeption wurde versucht möglichst realitätsnahe oder sogar tatsächlich beim Kunden aufgetretene Probleme einzubauen.
...
Nun da die Demoanwendung beschrieben ist, werden die Anforderungen näher erläutert, die das zu erstellende Konzept erfüllen soll.