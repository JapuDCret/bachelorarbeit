...
Ähnlich wie bei anderen Umgebungen gibt es eine standardisierte Log- bzw. Konsolenausgabe für die JavaScript-Umgebung \cite{MDNConsole}. Diese Ausgabe ist aber für den Standard-Benutzer eher unbekannt und es kann nicht erwartet werden, dass Nutzer dieses Log bereitstellen. Hinzukommend ist es, durch die zuvor beschrieben Härtungsmaßnahmen von Browsern, nicht möglich das Log direkt in eine Datei zu schreiben.
